...
public class PoolTable implements Drawable {
     ...
     * @param levelState The Level strategy. 
     */
    public PoolTable(String colourName, double friction, long dimX, long dimY, Level levelState) {
        this.init(colourName, friction, dimX, dimY);
        level = new EasyLevel(); // set default level as easy
    }
    ...
    private void init(String colourName, double friction, long dimX, long dimY) {
        ...
        // this.pockets.add(new Pocket(POCKET_OFFSET, POCKET_OFFSET, 50));
        // this.pockets.add(new Pocket(dimX / 2, POCKET_OFFSET, 50)); 
    ...
    /**
     * If the pocket object is not aleady in the list of pockets, 
     * add it.
     * @param pocket The pocket object. 
     */
    ...
    /**
     * Add each of the pockets given in parameter to 'this.pockets' 
     * @param pockets The list of pockets initialised in the Game class.
     */
    ...
    /**
     * Sets the level when certain keyboard key is pressed
    ...
    /**
     * Calls the concrete level classes individual method
     * @param game The instance of the game.
     */
    public void gameLevelFunction(Game game) {
        this.level.setLevelStrategy(game);
    }
