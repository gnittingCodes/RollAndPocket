...
/** A config class that will contain the pockets configuration */
public class PocketsConfig implements Configurable {
     ...
     */
    public PocketsConfig(PositionConfig posConf, double radius) {
    ...
    /**
     * Get the mass of the pocket as defined in the config.
